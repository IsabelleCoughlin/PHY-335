...
% *The second approximations for the numerical derivative of a function
% f(x) is found using a 2-point centered difference.*
...
%
% $$f'(x) = (\frac{1}{h})(f(x + \frac{1}{2}h) - f(x - \frac{1}{2}h))
% -\frac{1}{24}(h)^{2}(f'''(x))) + O(h^{4})$$
